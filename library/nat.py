...
def sort_table(section, field, table):
    ...
    Returns:
        list        Table data sorted by 'key' fields, as defined by the
                    vTM REST schema.
    """
    table_keys = {"basic": {"many_to_one_all_ports": ["rule_number", "pool", "tip"], "many_to_one_port_locked": ["rule_number", "pool", "port", "protocol", "tip"], "port_mapping": ["rule_number", "dport_first", "dport_last", "virtual_server"], "one_to_one": ["rule_number", "enable_inbound", "ip", "tip"]}}
