...
def sort_table(section, field, table):
    ...
    Returns:
        list        Table data sorted by 'key' fields, as defined by the
                    vTM REST schema.
    """
    table_keys = {"appliance": {"routes": ["name", "gw", "if", "mask"], "hosts": ["name", "ip_address"], "ip": ["name", "addr", "mask"], "if": ["name"]}, "basic": {"appliance_sysctl": ["sysctl", "value"], "trafficip": ["name", "networks"], "appliance_card": ["name", "interfaces"]}}
